...
SOURCES = main.cpp shutdown_manager.cpp utils.cpp audio_mixer.cpp beat_player.cpp udpServer.cpp joystick.cpp accelerometer.cpp gpio.cpp i2c.cpp air_drummer.cpp
